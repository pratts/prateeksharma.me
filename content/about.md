...
- **Backend Frameworks:** Node.js (NestJS, Express), Django, Flask, Spring Boot, Hibernate (JPA)
- **Databases:** PostgreSQL, MongoDB, MySQL, MariaDB, Redis, Meilisearch, Snowflake
- **Blockchain:** Cardano, Stellar, Bitcoin (Ordinals, Inscriptions, BRC-20, Runes), Akash, Axelar
- **Cloud & DevOps:** AWS (Chalice, Secret Manager), Docker, Kubernetes, Jenkins, GitHub Actions, Git, GitHub, Linux
- **Frontend Technologies:** Angular 2, HTML5, CSS3, JavaScript
- **Development Methodologies:** Agile, Scrum, Test-Driven Development
- **Messaging & Queues:** RabbitMQ, NATS, Redis Pub/Sub, Kafka (basic)
- **Workflow Orchestration:** Temporal
- **Monitoring & Observability:** OpenTelemetry, SigNoz, Kubernetes logs
- **Authentication:** Auth0, JWT, OAuth
- **Testing & Quality:** pytest, mypy, TDD
- **AI Tooling:** Claude Code (agentic coding workflows)
- **Specializations:** System Design, Database Optimization, API Development, Multi-tenant Architecture, Real-time Systems, Distributed Systems
